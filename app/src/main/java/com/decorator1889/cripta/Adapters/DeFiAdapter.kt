...
class DeFiAdapter(val companies: ArrayList<DeFiModel>, var listener: Clicker): RecyclerView.Adapter<DeFiAdapter.ViewHolder>(){

    interface Clicker{
        fun OnClick(company: DeFiModel)
    }
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
            ...
            val i = companies[p1].quote.USD.percent_change_24h.toDouble()

            val j = companies[p1].quote.USD.price.toDouble()
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun insertAddons(companies: DeFiModel, listener: Clicker){
